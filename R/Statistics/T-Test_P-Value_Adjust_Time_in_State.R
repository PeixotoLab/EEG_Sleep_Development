...
# P23 WT
P23_WT_Sleep_Ratio <- Time_in_State[c(1:7), 10]
P23_WT_Sleep_Ratio

# P23 MT
P23_MT_Sleep_Ratio <- Time_in_State[c(8:15), 10]
P23_MT_Sleep_Ratio

# P29 WT
P29_WT_Sleep_Ratio <- Time_in_State[c(16:22), 10]
P29_WT_Sleep_Ratio

# P29 MT
P29_MT_Sleep_Ratio <- Time_in_State[c(23:31), 10]
P29_MT_Sleep_Ratio

# P44 WT
P44_WT_Sleep_Ratio <- Time_in_State[c(32:37), 10]
P44_WT_Sleep_Ratio

# P44 MT
P44_MT_Sleep_Ratio <- Time_in_State[c(38:44), 10]
P44_MT_Sleep_Ratio

# P59 WT
P59_WT_Sleep_Ratio <- Time_in_State[c(45:52), 10]
P59_WT_Sleep_Ratio

# P59 MT
P59_MT_Sleep_Ratio <- Time_in_State[c(53:59), 10]
P59_MT_Sleep_Ratio

# Wild Type
# P23 vs P29
WT_P23_P29_Sleep_Ratio <- t.test(P23_WT_Sleep_Ratio, P29_WT_Sleep_Ratio, var.equal = TRUE)
WT_P23_P29_Sleep_Ratio_P_Value <- WT_P23_P29_Sleep_Ratio$p.value
# [1] 0.005510516

# P29 vs P44
WT_P29_P44_Sleep_Ratio <- t.test(P29_WT_Sleep_Ratio, P44_WT_Sleep_Ratio, var.equal = TRUE)
WT_P29_P44_Sleep_Ratio_P_Value <- WT_P29_P44_Sleep_Ratio$p.value
# [1] 0.8323628

# P44 vs P59
WT_P44_P59_Sleep_Ratio <- t.test(P44_WT_Sleep_Ratio, P59_WT_Sleep_Ratio, var.equal = TRUE)
WT_P44_P59_Sleep_Ratio_P_Value <- WT_P44_P59_Sleep_Ratio$p.value
# [1] 0.2486778

WT_Sleep_Ratio_Age <-c(WT_P23_P29_Sleep_Ratio_P_Value, WT_P29_P44_Sleep_Ratio_P_Value, WT_P44_P59_Sleep_Ratio_P_Value)
WT_Sleep_Ratio_Age_Adjust <- p.adjust(WT_Sleep_Ratio_Age,method="hochberg")
# [1] 0.01653155 0.83236283 0.49735555

# Mutant
# P23 vs P29
MT_P23_P29_Sleep_Ratio <- t.test(P23_MT_Sleep_Ratio, P29_MT_Sleep_Ratio, var.equal = TRUE)
MT_P23_P29_Sleep_Ratio_P_Value <- MT_P23_P29_Sleep_Ratio$p.value
# [1] 0.4376121

# P29 vs P44
MT_P29_P44_Sleep_Ratio <- t.test(P29_MT_Sleep_Ratio, P44_MT_Sleep_Ratio, var.equal = TRUE)
MT_P29_P44_Sleep_Ratio_P_Value <- MT_P29_P44_Sleep_Ratio$p.value
# [1] 0.05629012

# P44 vs P59
MT_P44_P59_Sleep_Ratio <- t.test(P44_MT_Sleep_Ratio, P59_MT_Sleep_Ratio, var.equal = TRUE)
MT_P44_P59_Sleep_Ratio_P_Value <- MT_P44_P59_Sleep_Ratio$p.value
# [1] 0.1786634

MT_Sleep_Ratio_Age <-c(MT_P23_P29_Sleep_Ratio_P_Value, MT_P29_P44_Sleep_Ratio_P_Value, MT_P44_P59_Sleep_Ratio_P_Value)
MT_Sleep_Ratio_Age_Adjust <- p.adjust(MT_Sleep_Ratio_Age,method="hochberg")
# [1] 0.4376121 0.1688704 0.3573269

#### Sleep Ratio, Genotype ####

# P23 WT vs MT
P23_Sleep_Ratio_Genotype <- t.test(P23_WT_Sleep_Ratio, P23_MT_Sleep_Ratio, var.equal = TRUE)
P23_Sleep_Ratio_Genotype_P_Value <- P23_Sleep_Ratio_Genotype$p.value
# [1] 0.0005972598

# P29 WT vs MT
P29_Sleep_Ratio_Genotype <- t.test(P29_WT_Sleep_Ratio, P29_MT_Sleep_Ratio, var.equal = TRUE)
P29_Sleep_Ratio_Genotype_P_Value <- P29_Sleep_Ratio_Genotype$p.value
# [1] 0.7118784

# P44 WT vs MT
P44_Sleep_Ratio_Genotype <- t.test(P44_WT_Sleep_Ratio, P44_MT_Sleep_Ratio, var.equal = TRUE)
P44_Sleep_Ratio_Genotype_P_Value <- P44_Sleep_Ratio_Genotype$p.value
# [1] 0.05428512

# P59 WT vs MT
P59_Sleep_Ratio_Genotype <- t.test(P59_WT_Sleep_Ratio, P59_MT_Sleep_Ratio, var.equal = TRUE)
P59_Sleep_Ratio_Genotype_P_Value <- P59_Sleep_Ratio_Genotype$p.value
# [1] 0.01011324

Sleep_Ratio_Genotype <-c(P23_Sleep_Ratio_Genotype_P_Value, P29_Sleep_Ratio_Genotype_P_Value, P44_Sleep_Ratio_Genotype_P_Value, P59_Sleep_Ratio_Genotype_P_Value)
Sleep_Ratio_Genotype_Adjust <- p.adjust(Sleep_Ratio_Genotype,method="hochberg")
# [1] 0.002389039 0.711878404 0.108570243 0.030339732
